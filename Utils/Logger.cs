...
public static class Log
{
  ...
  /// <summary>
  /// Gets or sets whether ANSI color codes are applied to log output.
  /// Set to false to disable coloring (useful for consoles that don't support ANSI escape codes).
  /// </summary>
  public static bool ColoredOutput { get; set; } = true;
  ...
  public static void Info(params object[] messages)
  {
    var callerInfo = DebugMode ? GetCallerInfo() : "";
    var message = string.Join(" ", messages);
    var coloredMessage = ColoredOutput ? $"\x1b[38;2;222;254;255m{message}\x1b[0m" : message;
